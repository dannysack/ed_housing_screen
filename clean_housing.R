...
data <- data %>%
  mutate(race = ifelse(race == "multi", "Multiple", race),
         race = ifelse(race == "American Indian or Alaska Native", "AIAN", race),
         race = ifelse(race == "Middle Eastern or North Africian", "MENA", race),
         race = ifelse(race %in% c("Native Hawaiian or Other Pacific Islander", "Other"), "None of these", race),
         ...
         eth_cat = ifelse(ethnicity %in% c("Cuban", 
                          ...
                          "Other Hispanic/Latino/a", NA),
         eth_cat = ifelse(is.na(eth_cat) & ethnicity %in% c("Decline to Answer",
                                                            "Prefer Not to Answer"),
                          "Prefer Not to Answer", eth_cat),
         eth_cat = ifelse(is.na(eth_cat) & ethnicity == "Mexican, Mexican American, or Chicano/a",
                          "Mexican", eth_cat),
         eth_cat = ifelse(is.na(eth_cat) & ethnicity == "Puerto Rican",
                          "Puerto Rican", eth_cat),
         eth_cat = ifelse(is.na(eth_cat) & ethnicity == "Unable to Provide",
                          "Unable to Provide", eth_cat),
         ...
         eth_cat = factor(eth_cat, levels = c("Other Hispanic/Latino/a", "Mexican", "Puerto Rican",
                                              "Not Hispanic/Latino/a", "Unable to Provide", "Prefer Not to Answer")),
