...
tot_encounters_use <- high_encounters %>% 
  ...
  annotate(geom = "rect", xmin = 1.55, xmax = 2.45, ymin = 0, ymax = .405,
           color = "black", alpha = 0, size = 0.75) +
  labs(title = "B) All VUMC ED Visits", subtitle = "") +
  xlab("Experiencing Homelessness") +
...
ggarrange(top, bot, nrow = 2) +
  annotate(geom = "rect", xmin = 0.505, xmax = 0.63, ymin = 0.505, ymax = 0.56, 
           color = "black", alpha = 0, size = 0.75) +
  annotate(geom = "text", label = "\"High Utilizers\"", x = 0.7, y = 0.535)
# dev.off()
# # embed the font
